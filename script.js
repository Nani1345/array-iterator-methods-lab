...
veryOldInventors = inventors.filter((inventor) => {
    return inventor.year > 1500 && inventor.year < 1599          //"between the years 1500 and 1599" does include the years 1500 and 1599.
})
...
isAdultPresent = devs.some((dev) => {
    return new Date().getFullYear() - dev.year === 18 || new Date().getFullYear() - dev.year > 18
})
